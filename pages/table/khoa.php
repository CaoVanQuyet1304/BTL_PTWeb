    ...
    <table class="table">
        ...
        <tr>
            ...
            <td class="tool-content">
                <li><a href="../config/connect.php?fix <?php echo $row['makhoa']; ?>" class="fix-content">Sửa</a>
                <li><a href="../config/connect.php?delete <?php echo $row['makhoa']; ?>" class="delete-content">Xóa</a>
            </td>
        </tr>
            <?php }?>
            </tbody>
